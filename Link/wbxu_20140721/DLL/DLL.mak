...
CLEAN :
	...
	-@erase "..\Bin\Dynamic\Debug\DLL.dll"
	-@erase "..\Bin\Dynamic\Debug\DLL.ilk"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\DLL.pdb" /debug /machine:I386 /out:"../Bin/Dynamic/Debug/DLL.dll" /implib:"$(OUTDIR)\DLL.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\DLL.OBJ"

"..\Bin\Dynamic\Debug\DLL.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\InjectDll.pdb" /machine:I386 /def:".\InjectDll.def" /out:"$(OUTDIR)\InjectDll.dll" /implib:"$(OUTDIR)\InjectDll.lib" 
DEF_FILE= \
	".\InjectDll.def"
LINK32_OBJS= \
...
ALL : "..\MySpy\Debug\InjectDll.dll" "$(OUTDIR)\InjectDll.bsc"
...
CLEAN :
	...
	-@erase "..\MySpy\Debug\InjectDll.dll"
	-@erase "..\MySpy\Debug\InjectDll.ilk"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\InjectDll.pdb" /debug /machine:I386 /def:".\InjectDll.def" /out:"../MySpy/Debug/InjectDll.dll" /implib:"$(OUTDIR)\InjectDll.lib" /pdbtype:sept 
DEF_FILE= \
	".\InjectDll.def"
LINK32_OBJS= \
	"$(INTDIR)\InjectDll.obj" \
...
"..\MySpy\Debug\InjectDll.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

#line 1 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
...
#line 5 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
#line 1 "e:\\program\\vc98\\include\\assert.h"
...
#line 17 "e:\\program\\vc98\\include\\assert.h"
...
#line 37 "e:\\program\\vc98\\include\\assert.h"
...
extern "C" {
#line 59 "e:\\program\\vc98\\include\\assert.h"

 void __cdecl _assert(void *, void *, unsigned);


}
#line 65 "e:\\program\\vc98\\include\\assert.h"



#line 69 "e:\\program\\vc98\\include\\assert.h"
#line 6 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
...
#line 8 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
...
#line 9 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
...
#line 21 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"



    WNDPROC g_OldProc[1024] = {0};
    HWND g_hWnd[1024] = {0};
    int g_nCount = 0;

    CRITICAL_SECTION g_cs;
#line 30 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
...
#line 72 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
    ...
    if (uMsg == 0x0111)
    {
         WORD wNotifyCode = ((WORD)(((DWORD)(wParam) >> 16) & 0xFFFF)); 
         ...
         if (hwndCtl != 0)
         {
            if (0x84 == wID 
                && 0 == wNotifyCode)
            {
                ::MessageBoxA(0, "8 Clicked", "Inject", 0x00000000L);
            }
         }
         else if (0 == wNotifyCode)
         {
            if ((0x0400 + 1) == wID)
            {
                MessageBoxA(0, "FEATURE", 0, 0x00000000L);
                



DialogBoxParamA(g_hModule, (LPSTR)((DWORD)((WORD)(101))), g_hCalc, DLGPROC(DlgProc), 0L);
            }
            else if ((0x0400 + 2) == wID)
            {
                MessageBoxA(0, "ABOUT", 0, 0x00000000L);
            }
        }
    }
    else if (0x0100 == uMsg)
    {
        ...
        if (0x24 == wParam)
        {
            ::MessageBoxA(0, "Home", 0, 0x00000000L);
...
#line 140 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
}



BOOL __stdcall EnumChildProc_Unicode(
                                    HWND hwnd,      
                                    LPARAM lParam   
                                    )
{
    g_hWnd[g_nCount] = hwnd;
    g_OldProc[g_nCount] = (WNDPROC)::SetWindowLongW(hwnd, (-4), (LONG)WindowProc);
    g_nCount++;

    return 1;
}

BOOL __stdcall EnumChildProc(
                            HWND hwnd,      
                            LPARAM lParam   
                            )
{
    g_hWnd[g_nCount] = hwnd;
    g_OldProc[g_nCount] = (WNDPROC)::SetWindowLongA(hwnd, (-4), (LONG)WindowProc);
    g_nCount++;
...
void CleanUP_Unicode()
{
    for (int i = 0; i < g_nCount; i++)
    {
        ::SetWindowLongW(g_hWnd[i], (-4), (LONG)g_OldProc[i]);
    }
}
...
void CleanUP()
{
    for (int i = 0; i < g_nCount; i++)
    {
        ::SetWindowLongA(g_hWnd[i], (-4), (LONG)g_OldProc[i]);
    }
}
#line 184 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"

void GetInjectWindow()
{
    HANDLE hMap = ::OpenFileMappingA(((0x000F0000L)|0x0001| 0x0002 | 0x0004 | 0x0008 | 0x0010), 
                                    0, 
                                    "Inj3ct");
    if (0 == hMap)
    {
    ...
    if (0 == g_hCalc)
    {
        MessageBoxA(0, "FindWindow Error", 0, 0x00000000L);
    }
}
...
#line 235 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
...
#line 298 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
}
...
#line 325 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"
}
...
void AddMenu()
{
    (void)( (g_hCalc != 0) || (_assert("g_hCalc != NULL", "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp", 332), 0) );
    ...
    bRet = AppendMenuA(hSubMenu, 0x00000000L, (0x0400 + 1), "功能");
    if (!bRet)
    {
    ...
    bRet = AppendMenuA(hSubMenu, 0x00000000L, (0x0400 + 2), "关于");
    if (!bRet)
    {
        CloseHandle(hSubMenu);
        hSubMenu = 0;
...
void UnloadDLL()
{
    ...
    (void)( (g_hModule != 0) || (_assert("g_hModule != NULL", "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp", 411), 0) );
					 ...
					 )
{
    ...
    if (ul_reason_for_call == 1)
    {
        ...
        ::MessageBoxA(0, "我来了", 0, 0x00000000L);
    }
...
#line 455 "e:\\programming\\git\\ph2\\link\\program\\p20140808_spy\\wbxu_20140808\\injectdll\\injectdll.cpp"

        ::MessageBoxA(0, "我走了", 0, 0x00000000L);
    }

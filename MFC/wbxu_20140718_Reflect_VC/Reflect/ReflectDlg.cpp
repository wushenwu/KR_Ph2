...
void CReflectDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CReflectDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CReflectDlg::OnButton1() 
{
	// TODO: Add your control notification handler code here
	AfxMessageBox("CReflectDlg::OnButton1");
}

HBRUSH CReflectDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{

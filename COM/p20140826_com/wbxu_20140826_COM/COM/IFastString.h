...
//////////////////////////////////////////////////////////////////////////
//IFastStingFactory
class IFastStringFactory : public IBase
{
public:
    virtual ~IFastStringFactory() {}
...
typedef HRESULT (*PFNCreateFastStringFactory)(void **ppFactory);

// {63E9672D-AAEF-4140-8CFE-7BEDCB4F1741}
static const GUID IID_IFastStringFactory = 

...
void CMyRect::CopyOther(IShape *pobj)
{
...
void CMyRect::SetPen(tagPen pen)
{
    m_tagPen = pen;
}

void CMyRect::SetBrush(tagBrush brush)
{
    m_tagBrush = brush;
}

tagPen CMyRect::GetPen()
{
    return m_tagPen;
}

tagBrush CMyRect::GetBrush()
{
    return m_tagBrush;
}
...
const TCHAR *CMyRectFactory::GetName()
{
    return SHAPE_NAME;  
}

void CMyRectFactory::Release()
{
    delete this;
}

IShape *CMyRectFactory::CreateShape()
{
    return new CMyRect();
}

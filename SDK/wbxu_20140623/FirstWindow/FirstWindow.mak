...
ALL : "$(OUTDIR)\FirstWindow.exe" "$(OUTDIR)\FirstWindow.bsc"


CLEAN :
	-@erase "$(INTDIR)\FirstWindow.obj"
	-@erase "$(INTDIR)\FirstWindow.res"
	-@erase "$(INTDIR)\FirstWindow.sbr"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(OUTDIR)\FirstWindow.bsc"
	-@erase "$(OUTDIR)\FirstWindow.exe"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\FirstWindow.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
MTL_PROJ=/nologo /D "_DEBUG" /mktyplib203 /win32 
RSC_PROJ=/l 0x804 /fo"$(INTDIR)\FirstWindow.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\FirstWindow.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\FirstWindow.sbr"

"$(OUTDIR)\FirstWindow.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<

LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\FirstWindow.pdb" /debug /machine:I386 /out:"$(OUTDIR)\FirstWindow.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\FirstWindow.obj" \
	"$(INTDIR)\FirstWindow.res"
...
"$(INTDIR)\FirstWindow.obj"	"$(INTDIR)\FirstWindow.sbr" : $(SOURCE) "$(INTDIR)"
